...
10. Reports & Analytics Screen
    ...
    Basic Workflow
11. 2. 5. 6. 7. 8. Procurement Officer creates an RFQ.
                   Vendors receive invitations and submit quotations.
12. Procurement team compares quotations.
13. Approval workflow is initiated.
    Approved quotations generate Purchase Orders.
    Invoice is generated from the Purchase Order.
    Invoice can be printed or emailed directly.
    Procurement activities are tracked through logs and analytics.
    Mock Up:- https://app.excalidraw.com/l/65VNwvy7c4X/5ywnm0v3qhK
